      ...
      <body>
        ...
        <footer style={{
          ...
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            {/* Instagram */}
            <a href="https://www.instagram.com/sailcsulb/" target="_blank" rel="noopener noreferrer" style={{ color: '#9ca3af', display: 'flex', alignItems: 'center' }}>
            ...
            {/* Discord */}
            <a href="https://discord.gg/DYuD3Zs4JE" target="_blank" rel="noopener noreferrer" style={{ color: '#9ca3af', display: 'flex', alignItems: 'center' }}>
